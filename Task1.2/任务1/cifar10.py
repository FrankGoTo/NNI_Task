...
def main(args):
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        # TODO:report intermediate result
        nni.report_intermediate_result(top1)
    # TODO:report final result
    nni.report_final_result(top1)
    logger.info("Final accuracy is: %.6f", top1)  # acc Log
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr_scheduler', default='linear', type=str, help='lr_scheduler',
    ...
    parser.add_argument('--model', default='vgg16', choices=available_models, help='the model to use')
