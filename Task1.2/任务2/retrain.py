...
if __name__ == "__main__":
    ...
    parser.add_argument("--arc-checkpoint", default="./checkpoints_layer5/epoch_49.json")
    ...
    optimizer = torch.optim.SGD(model.parameters(), 0.1, momentum=0.9, weight_decay=3.0E-4)
